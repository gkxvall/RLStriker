...
class Field:
    ...
    def reset_entities(self) -> tuple[Player, Player, Ball]:
        ...
        self.player_1 = Player(p1_x, center_y, C.COLOR_PLAYER_1, "1", team=1)
        self.player_2 = Player(p2_x, center_y, C.COLOR_PLAYER_2, "2", team=2)
    ...
    def _draw_goals(self, surface: pygame.Surface) -> None:
        ...
        for goal_rect in (left_goal, right_goal):
            ...
            for i in range(1, 4):
                ...
                pygame.draw.line(
                    surface, C.COLOR_GOAL_NET, (goal_rect.left, y), (goal_rect.right, y), 1
                )
